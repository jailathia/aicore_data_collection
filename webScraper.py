...
class Scraper:
    ...
    def get_fixture_link_list(self):
        ...
        home_games = fixture_list.find_elements(By.XPATH, '//li[@data-home="Man Utd"]')
        away_games = fixture_list.find_elements(By.XPATH, '//li[@data-away="Man Utd"]')
        link_list = []
    ...
    def get_stats(self):
        ...
        '''Returns Man Utd's match statistics in a list.'''
        sleep(self.pause_time)
